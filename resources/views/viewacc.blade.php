...
@foreach($res as $value)
                  <tr>
						...
						<td><a class="text-white" href="editacc/{{ $value->id }}"><button class="btn btn-info">Edit</button></a></td>
						<td><a class="text-white" href="deleteacc/{{ $value->id }}" onclick="return confirm('Are you sure you want to delete this item?');"><button class="btn btn-danger">Delete</button></a></td>
</tr>
                  @endforeach
</tbody>
