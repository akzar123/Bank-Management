...
<div class="inner-block">
    <div class="blank">
		...
		<div class="card">
		  <div class="card-body">
		   	<form  method="post" action="/addaccqry"  enctype="multipart/form-data">
			  ...
			  <div class="form-group">
			    ...
			    <input type="number" class="form-control" name="bal" placeholder="Enter balance" required>
			    
			  </div>
			   <div class="form-group">
			     <label for="acctype" class="text-white">Account Type</label>
			    <input type="text" class="form-control" name="acctype" placeholder="Enter account type" required>
			    
			  </div>
			   <div class="form-group">
   				 <label for="cid" class="text-white">Customer ID</label>
  				  <input type="number" class="form-control" name="cid" placeholder="Enter the customer id" required>
  				   
  				   
  				</div>
  				<div class="form-group">
   				 <label for="branchno" class="text-white">Branch number</label>
  				  <input type="number" class="form-control" name="branchno" placeholder="Enter the branch number" required>
